/*
 * File: ListRoomAmenitiesAdapter.java
 *
...
/**
 * Adapter that manages a collection of {@link AmenitiesAttribute}.
 * Array of integers with the following attributes: amenity:
...
public class ListRoomAmenitiesAdapter extends RecyclerView.Adapter<ListRoomAmenitiesAdapter.AmenitiesHolder> {
    private List<AmenitiesAttribute> amenitiesList;

    ListRoomAmenitiesAdapter() {
    ...
    public void setAmenities(List<AmenitiesAttribute> amenities) {
