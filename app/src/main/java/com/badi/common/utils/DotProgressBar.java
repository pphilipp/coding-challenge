...
public class DotProgressBar extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        dotXCoordinate = (getMeasuredWidth() - circlesWidth) / 2 + dotRadius;
    }
    ...
    private void initializeAttributes(AttributeSet attrs) {
        if (attrs != null) {
            ...
            setStartColor(ContextCompat.getColor(getContext(), R.color.grey_400));
            setEndColor(ContextCompat.getColor(getContext(), R.color.white));
