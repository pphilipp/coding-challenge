 ...
 * retrieving the search room data
 */

public class GetRoomsBySearch extends UseCase {
    ...
    @Inject
    public GetRoomsBySearch(RoomRepository roomRepository, ThreadExecutor threadExecutor,
    ...
    public Observable buildUseCaseObservable() {
        ...
        Timber.i("GetRoomsBySearch: ".concat(request.toString()));
        return roomRepository.getRoomsBySearch(request);
    }
}
